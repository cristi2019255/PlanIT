...
import com.example.plan_it.Company
import com.example.plan_it.Inscriere
import com.example.plan_it.R


class CompanyAdapter(var mContext:Context,var mCompanies:ArrayList<Company>) : RecyclerView.Adapter<CompanyAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
          name=itemView.findViewById(R.id.company_name_in_company_item)
          adress=itemView.findViewById(R.id.adress_company_in_company_item)
          planifica=itemView.findViewById(R.id.planifica_in_compani_item)
